#!/bin/bash
# Script clears contentx of listed Oak directories while retaining the top-level directory for tracking purposes

# Configuration variables
PARENT_DIR="/oak/stanford/groups/<groupname>/users"         # Replace with your parent directory path
INPUT_FILE="oak_directories_list.txt"                       # File containing list of subdirectories
